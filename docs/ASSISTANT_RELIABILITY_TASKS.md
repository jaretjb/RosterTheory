...
| AC-008 | [#14](https://github.com/jaretjb/RosterTheory/issues/14) | Implemented on `codex/ac-008-release-gates`; PR pending |
...
Status: merged in [PR #21](https://github.com/jaretjb/RosterTheory/pull/21).
All 20 CI checks passed; issue #12 is closed. Finding: D3. Depends on AC-001 (merged).
...
Status: IMPLEMENTED ON BRANCH; MERGE PENDING. Findings: Q1, Q2. Depends on AC-003 through AC-007.
